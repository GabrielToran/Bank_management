...
<c:if test="${customer == null}">
    <div class="alert alert-danger">Customer object is missing!</div>
</c:if>
<c:if test="${empty accounts}">
    <div class="alert alert-warning">Accounts list is empty or null.</div>
</c:if>
...
<div class="container mt-4">
    ...
    <div class="mb-3">
        ...
        <a href="${pageContext.request.contextPath}/accounts/new?customerId=${customer.customerId}" class="btn btn-success">Create New Account</a>
    </div>
